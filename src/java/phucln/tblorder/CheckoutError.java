...
public class CheckoutError implements Serializable {
    ...
    private String discountCodeIsExpiredError;
    private String bookIsOutOfStockError;

    public CheckoutError() {
    }

    public CheckoutError(String discountCodeNoExistError, String discountCodeAlreadyUsedError, String discountCodeIsExpiredError, String bookIsOutOfStockError) {
        this.discountCodeNoExistError = discountCodeNoExistError;
        this.discountCodeAlreadyUsedError = discountCodeAlreadyUsedError;
        this.discountCodeIsExpiredError = discountCodeIsExpiredError;
    ...
    /**
     * @param discountCodeAlreadyUsedError the discountCodeAlreadyUsedError to
     * set
     */
    ...
    /**
     * @return the discountCodeIsExpiredError
     */
    public String getDiscountCodeIsExpiredError() {
        return discountCodeIsExpiredError;
    }

    /**
     * @param discountCodeIsExpiredError the discountCodeIsExpiredError to set
     */
    public void setDiscountCodeIsExpiredError(String discountCodeIsExpiredError) {
        this.discountCodeIsExpiredError = discountCodeIsExpiredError;
    }
